...
namespace NBTExplorer.Controllers
{
    ...
    public class NodeTreeController
    {
        ...
        public ContextMenuStrip BuildNodeContextMenu (TreeNode frontNode, DataNode node)
        {
            ...
            if (node.HasUnexpandedChildren || node.Nodes.Count > 0) {
                if (frontNode.IsExpanded) {
                    ToolStripMenuItem itemCollapse = new ToolStripMenuItem("&C 展开", null, _contextCollapse_Click);
                    itemCollapse.Font = new System.Drawing.Font(itemCollapse.Font, System.Drawing.FontStyle.Bold);

                    ToolStripMenuItem itemExpandChildren = new ToolStripMenuItem("&H 展开子项目", null, _contextExpandChildren_Click);
                    ToolStripMenuItem itemExpandTree = new ToolStripMenuItem("&T 展开树", null, _contextExpandTree_Click);
                    ...
                    ToolStripMenuItem itemExpand = new ToolStripMenuItem("&E 展开", null, _contextExpand_Click);
            ...
            if (node.CanReoderNode) {
                ToolStripMenuItem itemUp = new ToolStripMenuItem("&U 上移", Properties.Resources.ArrowUp, _contextMoveUp_Click);
                ToolStripMenuItem itemDn = new ToolStripMenuItem("&D 下移", Properties.Resources.ArrowDown, _contextMoveDown_Click);
            ...
            if (node is DirectoryDataNode) {
                ...
                ToolStripMenuItem itemOpenExplorer = new ToolStripMenuItem("&X 在 Explorer 中打开", null, _contextOpenInExplorer_Click);
        ...
        private void _contextOpenInExplorer_Click (object sender, EventArgs e)
        {
            if (_multiTree.SelectedNode != null && _multiTree.SelectedNode.Tag is DirectoryDataNode) {
                ...
                try {
                    ...
                    MessageBox.Show(ex.Message, "无法打开文件夹！", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
